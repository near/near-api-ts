...
import { AccountIdZodSchema } from '../../../src/_common/zodSchemas/accountId';

z.config(z.locales.en());

describe('AccountIdZodSchema', () => {
  it.each(['ab', 'nat', 'bob.near', 'a-b.c_d.near', '12-1', 'sub.account.testnet', 'a'.repeat(64)])(
    'accepts a valid account id: %s',
    (accountId) => {
