...
import { convertUnitsToDecimal } from '../../../src/_common/_common/unitConverter/convertUnitsToDecimal';

describe('convertUnitsToDecimal', () => {
  it.each([
    // Zero
    [0n, 1, '0'],
    [0n, 24, '0'],
    ...
    const v = convertUnitsToDecimal(units, decimals);
