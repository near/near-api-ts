...
const r10 = client.callContractReadFunction({
  contractAccountId,
  functionName,
});
type _T10 = Assert<Equal<OutputResult<typeof r10>, unknown>>;

const r11 = client.callContractReadFunction<undefined>({
  contractAccountId,
  functionName,
});
type _T11 = Assert<Equal<OutputResult<typeof r11>, unknown>>;

const r12 = client.callContractReadFunction({
  contractAccountId,
  functionName,
...
const r13 = client.callContractReadFunction<undefined>({
  contractAccountId,
  functionName,
  functionArgs: undefined,
});
...
const r14 = client.callContractReadFunction({
  contractAccountId,
  functionName,
  functionArgs: { a: 1 },
});
...
const r15 = client.callContractReadFunction<{ a: number }>({
  contractAccountId,
  functionName,
  functionArgs: { a: 1 },
});
...
const knownResult20 = client.callContractReadFunction({
  contractAccountId,
  functionName,
...
const knownResult24 = client.callContractReadFunction<
  (args: { rawResult: Base64String }) => { decimals: number },
  { a: number }
>({
  contractAccountId,
  functionName,
...
const r30 = client.callContractReadFunction({
  contractAccountId,
  functionName,
  options: {
...
const r31 = client.callContractReadFunction({
  contractAccountId,
  functionName,
  functionArgs: undefined,
  options: {
...
const r33 = client.callContractReadFunction({
  contractAccountId,
  functionName,
  functionArgs: undefined,
  options: {
...
const r34 = client.callContractReadFunction({
  contractAccountId,
  functionName,
  functionArgs: { b: 1n },
  options: {
...
const r36 = client.callContractReadFunction<
...
const knownResult31 = client.callContractReadFunction({
  contractAccountId,
  functionName,
  functionArgs: { b: 1n },
  options: {
...
client.callContractReadFunction<SerializeBigintArgs>({
  contractAccountId,
  functionName,
...
client.callContractReadFunction<SerializeEmptyArgs>({
  contractAccountId,
  functionName,
