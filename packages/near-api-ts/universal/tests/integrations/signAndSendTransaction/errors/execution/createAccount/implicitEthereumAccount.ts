...
export const implicitEthereumAccount = (context: TestContext) => async () => {
  ...
  const signedTransaction = await signTransaction({
    ...
    transaction: {
      ...
      receiverAccountId: '0x0123456789012345678901234567890123456789',
    },
  });
  ...
  expect(txResult.result.error.context).toStrictEqual({
    newAccountId: '0x0123456789012345678901234567890123456789',
  });
};
