...
import type { TransactionDetailsFromStageConvertedFinal } from '../../../../../../../types/client/methods/transaction/sendSignedTransaction/output';
...
export const getDetailsFromStageConvertedFinal = (
