...
export const createSafeSignTransaction = (context: MemoryKeyServiceContext): SafeSignTransaction =>
  wrapInternalError('MemoryKeyService.SignTransaction.Internal', async (args) => {
